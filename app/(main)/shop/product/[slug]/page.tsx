...
const PRODUCTS: Record<string, {
  ...
  'gn-bat-legend-2': {
    id: 'gn-bat-legend-2', name: 'Gray Nicolls Destroyer DXM', brand: 'Gray Nicolls', category: 'Bats',
    price: 650, compare: 780, rating: 4.6, reviews: 88, vendor: 'Cricket Store Dubai', vendor_id: 'v1',
    badge: 'Sale', inStock: true,
    image: '', desc: 'Grade 2 English Willow. Great value for club cricketers. Same DXM technology as the Legend at a lower price point. Perfect for UAE club cricket conditions.',
    specs: { Brand: 'Gray Nicolls', Model: 'Destroyer DXM', Grade: 'Grade 2 English Willow', Weight: '2.8–3.0 lbs', Handle: 'Short/Long Handle', Edges: '38mm' },
    includes: ['Bat', 'Toe guard (fitted)', 'Anti-scuff sheet (fitted)'],
  },
  'gm-pads-six6': {
    id: 'gm-pads-six6', name: 'GM Six6 Batting Pads', brand: 'GM', category: 'Pads',
    price: 280, compare: undefined, rating: 4.5, reviews: 52, vendor: 'Sports World UAE', vendor_id: 'v2',
    badge: undefined, inStock: true,
    image: '', desc: 'GM Six6 batting pads — lightweight with maximum protection. Top choice for UAE club cricketers. Used by international players. All straps included.',
    specs: { Brand: 'GM', Model: 'Six6', Sizes: 'Youth / Small / Medium / Large / XL', Style: 'Right or Left Hand', Material: 'High-density foam', Straps: '3 straps included' },
    includes: ['1 pair batting pads'],
  },
  'ss-ton-pads-supreme': {
    id: 'ss-ton-pads-supreme', name: 'SS Ton Supreme Batting Pads', brand: 'SS Ton', category: 'Pads',
    price: 320, compare: undefined, rating: 4.4, reviews: 38, vendor: 'UAE Cricket Kits', vendor_id: 'v3',
    badge: undefined, inStock: true,
    image: '', desc: 'SS Ton Supreme batting pads used by Indian national team players. Premium protection with a lightweight feel. High-density foam with reinforced knee roll.',
    specs: { Brand: 'SS Ton', Model: 'Supreme', Sizes: 'Small / Medium / Large / XL', Style: 'Right or Left Hand', 'Knee Roll': 'Reinforced' },
    includes: ['1 pair batting pads'],
  },
  'custom-jersey-5': {
    id: 'custom-jersey-5', name: 'Custom Club Jerseys (Min 5 pieces)', brand: 'Custom Print', category: 'Jerseys',
    price: 350, compare: undefined, rating: 4.8, reviews: 167, vendor: 'UAE Cricket Kits', vendor_id: 'v3',
    badge: 'Popular', inStock: true,
    image: '', desc: 'Professional full sublimation custom cricket jerseys. Minimum 5 pieces. Send your club name, logo and player numbers via WhatsApp — we handle the rest. Delivered in 7 days anywhere in UAE.',
    specs: { Minimum: '5 pieces', 'Price per jersey': 'AED 70', Material: 'Moisture-wicking Polyester', Print: 'Full Sublimation', Turnaround: '7 business days', Delivery: 'Free UAE-wide' },
    includes: ['Custom jerseys (qty as ordered)', 'Free design service', 'Free UAE delivery'],
  },
  'kit-bag-duffle': {
    id: 'kit-bag-duffle', name: 'Large Cricket Kit Bag — Duffle Style', brand: 'Kookaburra', category: 'Bags',
    price: 180, compare: 220, rating: 4.5, reviews: 73, vendor: 'UAE Cricket Kits', vendor_id: 'v3',
    badge: undefined, inStock: true,
    image: '', desc: 'Kookaburra duffle style cricket kit bag. Fits full adult cricket kit comfortably. Multiple compartments, dedicated bat sleeve for up to 3 bats, separate shoe compartment.',
    specs: { Brand: 'Kookaburra', Style: 'Duffle', 'Bat Sleeve': 'Up to 3 bats', 'Shoe Compartment': 'Yes', Dimensions: '90cm x 35cm x 35cm', Straps: 'Padded shoulder + carry handles' },
    includes: ['Kit bag'],
  },
  'kookaburra-match-balls': {
    id: 'kookaburra-match-balls', name: 'Kookaburra Match Balls × 12', brand: 'Kookaburra', category: 'Balls',
    price: 480, compare: 540, rating: 4.8, reviews: 45, vendor: 'ICC Academy Store', vendor_id: 'v4',
    badge: undefined, inStock: true,
    image: '', desc: 'Official Kookaburra match balls. Bulk pack of 12. Used in ILT20 and UAE domestic competitions. Same ball used in international cricket. 4-piece construction.',
    specs: { Brand: 'Kookaburra', Type: 'Match', Colour: 'Red', Quantity: '12 balls', Construction: '4-piece', Grade: 'Match Quality', Standard: 'ICC Approved' },
    includes: ['12 Kookaburra match balls', 'Original packaging'],
  },
